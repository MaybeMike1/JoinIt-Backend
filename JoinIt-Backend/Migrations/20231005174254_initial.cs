    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActiveActivitiesId = table.Column<int>(type: "int", nullable: false),
                    AttendantsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityUser", x => new { x.ActiveActivitiesId, x.AttendantsId });
                    table.ForeignKey(
                        name: "FK_ActivityUser_Activities_ActiveActivitiesId",
                        column: x => x.ActiveActivitiesId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActivityUser_Users_AttendantsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityUser_AttendantsId",
                table: "ActivityUser",
                column: "AttendantsId");
